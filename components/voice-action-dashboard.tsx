            ...
            <Button variant="ghost" size="sm" onClick={() => setIsSettingsOpen(true)}>
              <span className="flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-1.14 1.902-1.14 2.202 0a1.724 1.724 0 002.573 1.066c1.01-.606 2.296.68 1.69 1.69a1.724 1.724 0 001.065 2.573c1.14.3 1.14 1.902 0 2.202a1.724 1.724 0 00-1.066 2.573c.607 1.01-.68 2.296-1.69 1.69a1.724 1.724 0 00-2.572 1.065c-.3 1.14-1.902 1.14-2.202 0a1.724 1.724 0 00-2.573-1.066c-1.01.607-2.296-.68-1.69-1.69a1.724 1.724 0 00-1.065-2.572c-1.14-.3-1.14-1.902 0-2.202a1.724 1.724 0 001.066-2.573c-.607-1.01.68-2.296 1.69-1.69a1.724 1.724 0 002.572-1.065z" />
