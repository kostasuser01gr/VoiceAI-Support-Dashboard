...
class TestSQLInjection:
    ...
    def test_fstring_sql_injection(self, analyzer):
        code = '''
...
'''
    ...
    def test_format_sql_injection(self, analyzer):
        code = '''
...
class TestRCE:
    ...
    def test_eval_with_user_input(self, analyzer):
        code = '''
def process(data):
...
'''
    ...
    def test_exec_with_user_input(self, analyzer):
        code = '''
def run(user_code):
    exec(user_input)
'''
...
class TestHardcodedSecrets:
    ...
    def test_env_var_is_safe(self, analyzer):
...
class TestCommandInjection:
    ...
    def test_shell_true(self, analyzer):
...
class TestInsecureDeserialization:
    ...
    def test_pickle_load(self, analyzer):
        code = '''
import pickle
...
class TestTLSVerification:
    ...
    def test_verify_false(self, analyzer):
...
class TestRiskScoring:
    ...
    def test_single_p0(self, analyzer):
        findings = [Finding(
            rule_id="SEC-001", title="SQLi", description="",
            severity="P0", line_number=1, line_content="",
            cwe_id="CWE-89", owasp_category=""
        )]
        assert analyzer.calculate_risk_score(findings) == 4.0

    def test_capped_at_10(self, analyzer):
        findings = [
            Finding(rule_id=f"SEC-{i}", title="", description="",
                    severity="P0", line_number=i, line_content="",
                    cwe_id="CWE-89", owasp_category="")
            for i in range(5)
        ]
...
class TestComplianceStatus:
    ...
    def test_sqli_fails_owasp(self, analyzer):
        findings = [Finding(
            rule_id="SEC-001", title="SQLi", description="",
            severity="P0", line_number=1, line_content="",
            cwe_id="CWE-89", owasp_category=""
    ...
    def test_hardcoded_secret_fails_soc2(self, analyzer):
        findings = [Finding(
            rule_id="SEC-003", title="Secret", description="",
            severity="P0", line_number=1, line_content="",
            cwe_id="CWE-798", owasp_category=""
        )]
